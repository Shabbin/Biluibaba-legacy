  ...
  return (
    <div className="space-y-6">
      ...
      <div className="page-header">
        ...
        <p>Products currently live on the store</p>
      ...
      {products.length > 0 ? (
        <div className="bg-white rounded-2xl border border-border/60 shadow-sm overflow-hidden">
          <Table>
            <TableCaption className="py-4 text-muted-foreground">
              Showing {products.length} of {totalProducts} published products
            </TableCaption>
            <TableHeader>
        ...
        <div className="empty-state">
          ...
          <p>Products will appear here once they&apos;re approved and published.</p>
        </div>
      )}
