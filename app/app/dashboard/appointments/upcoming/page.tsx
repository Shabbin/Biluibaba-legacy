  ...
  const fetchAppointments = async (pageCount = 0) => {
    try {
      const { data } = await axios.get(
        `/api/vet/upcoming-appointments?count=${pageCount}`
      );
  ...
  return (
    <div className="space-y-6">
      <div className="page-header">
        ...
        <p>Your scheduled appointments that are coming up</p>
      ...
      {appointments.length > 0 ? (
        ...
        <div className="empty-state">
          ...
          <p>New appointments will show up here once they&apos;re scheduled.</p>
        </div>
      )}
