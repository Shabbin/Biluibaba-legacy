...
function DaySlots({ day }: DaySlotsProps): JSX.Element {
  const [duration] = useState<SelectOption[]>([
  ...
  const [interval] = useState<SelectOption[]>([
    { value: "5", text: "5 mins" },
  ...
  return (
    <div className="p-5 rounded-xl border">
      <p className="p-4 bg-zinc-800 text-white rounded-lg mx-auto">{day}</p>

      <TimePicker.RangePicker className="mt-3 w-full" size="large" />

      <div className="flex flex-row ms-1 gap-2 items-center">
        <label>Duration: </label>
        <Select value={duration[0].text} data={duration} />
      </div>
      <div className="flex flex-row ms-1 gap-2 items-center">
        <label>Interval: </label>
        <Select value={interval[0].text} data={interval} />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="border p-5 rounded-xl my-5">
        ...
        <img className="my-5 rounded-full" src="/vets/vet1.webp" alt="Profile" />
      </div>
      ...
      <div className="border p-5 rounded-xl my-5">
        ...
        <div className="my-5 flex md:flex-row flex-col gap-5 justify-between">
          ...
          <div className="basis-1/3">
            ...
            <Input type="text" placeholder="Enter your linkedin profile link" />
          </div>
        </div>
      </div>
