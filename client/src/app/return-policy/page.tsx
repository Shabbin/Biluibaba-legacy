...
const ReturnPolicy = () => {
  return (
    <PolicyLayout title="Return Policy" lastUpdated="October 24, 2025" type="return">
      <p>
        We offer a <strong>7-day return policy</strong> for most items. To be eligible for a return, your item must be in the same condition that you received it. It must also be in the original packaging.
      </p>
      ...
      <ul>
        ...
        <li>The item is returned within 7 days of receipt.</li>
      ...
      <h3>7. Vendor Compliance</h3>
      <p>
        Vendors must honor Biluibaba's return and refund policies. Failure to comply may result in account suspension or termination.
      </p>
    </PolicyLayout>
  );
};
