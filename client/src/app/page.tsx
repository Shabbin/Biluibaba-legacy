...
import { SiteSettings, SliderItem, CategoryItem, BannerImage, BrandItem } from '@/src/types';
...
interface SiteState {
  ...
  popular_product_category: Array<{
    _id: string;
    category: string;
    categorySlug: string;
    image: string;
  ...
  product_brands_in_spotlight: Array<{
    name: string;
    path: string;
  }>;
    ...
    <main>
      {!loading && (
        <>
          ...
          <div className="container mx-auto py-10">
            <h1 className="md:text-6xl text-5xl font-bold text-center">Best Seller</h1>
            <FeatureProducts type="featured" category="all" router={router} />
          </div>
          ...
          <div className="container mx-auto py-20 md:px-0 px-5">
            ...
            <div className="flex flex-col gap-10 text-2xl text-gray-500">
              <p>
                Welcome to Biluibaba, your ultimate online pet store in Bangladesh! At
                Biluibaba, we&apos;re more than just a pet shop online - we&apos;re your
                partners in pet parenting. With a passion for enhancing the lives of pets
                and pet parents with our pet products, we offer a wide array of pet
                essentials that cater to your pets&apos; every need.
              </p>
              <p>
                As the best online pet store in Bangladesh, we bring you a curated
                selection of pet products that are not only of the highest quality but
                also designed to make your pets&apos; lives happier and healthier.
              </p>
              <p>
                Gone are the days of searching for a &quot;pet store near me&quot; or
                &quot;pet shop near me&quot;.With Biluibaba, pet online shopping becomes a
                breeze. Get all your pet supplies delivered in just 120 minutes!
              </p>
              <p>
                As your trusted online pet shop in Bangladesh, we understand the unique
                bond you share with your pets. That&apos;s why we ensure that every pet
                product we offer is chosen with care and consideration.
              </p>
              <p>
                We take pride in being the best online cat and dog store as well. Your
                pets deserve the best, and we are here to provide it. With a variety of
                cat and dog shop products, you can keep your pets wagging their tails with
                joy.
              </p>
            </div>
          </div>
