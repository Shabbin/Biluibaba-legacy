...
export default function Page(): JSX.Element {
  ...
  const [bestDeals, setBestDeals] = useState<DealItem[]>([]);
  ...
  const [timestampInitialized, setTimestampInitialized] = useState<boolean>(false);
  ...
  const fetchDeals = async (pageCount: number): Promise<void> => {
    try {
