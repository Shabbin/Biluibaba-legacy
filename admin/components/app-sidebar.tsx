...
import { FaUserDoctor, FaGear } from "react-icons/fa6";
                      ...
                      <SidebarMenuSubItem>
                        <SidebarMenuSubButton asChild>
                          <Link href="/dashboard/products/unpublished">
                            <span>Unpublished Products</span>
                          </Link>
                        </SidebarMenuSubButton>
                      </SidebarMenuSubItem>
                    </SidebarMenuSub>
                      ...
                      <SidebarMenuSubItem>
                        <SidebarMenuSubButton asChild>
                          <Link href="/dashboard/site-settings/product-landing-slider">
                            <span>Product Landing Slider</span>
                          </Link>
                        </SidebarMenuSubButton>
                      </SidebarMenuSubItem>
                      ...
                      <SidebarMenuSubItem>
                        <SidebarMenuSubButton asChild>
                          <Link href="/dashboard/site-settings/popular-category-product">
                            <span>Popular Category & Featured Product</span>
                          </Link>
                        </SidebarMenuSubButton>
                      </SidebarMenuSubItem>
